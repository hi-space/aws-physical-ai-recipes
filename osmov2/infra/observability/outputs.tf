...
output "grafana_provisioner_service_account_id" {
  description = "AMG service account ID used by scripts/deploy-observability.sh to create a short-lived API token."
  value       = aws_grafana_workspace_service_account.provisioner.service_account_id
}

output "grafana_datasource_name" {
  description = "AMG Prometheus data source name provisioned by scripts/deploy-observability.sh."
  value       = var.grafana_datasource_name
}

output "grafana_datasource_uid" {
  description = "AMG Prometheus data source UID provisioned by scripts/deploy-observability.sh."
