"""SO-101 MuJoCo tasks for the Physical AI on AWS workshop (RL track, module 9B).
...
The IDs mirror the Isaac Lab tasks of module 9 (``Workshop-SO101-Reach-v0``) with a
