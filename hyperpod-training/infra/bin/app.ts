...
// eks = HyperPodEks-<ACCOUNT_ID> EKS 스택(모듈 8–11: 학습, observability, task governance). 두 스택은 공존하며 프로필 제한은 없다.
...
if (orchestrator === 'eks') {
  ...
  // 상시 시스템 노드(ml.c5.4xlarge)에서 MuJoCo CPU 경로(모듈 9~10)로 학습·검증하고, 모듈 11에서 2대로 올려 거버넌스·관측 실습을 진행한다.
