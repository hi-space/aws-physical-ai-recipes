...
export interface HyperPodEksStackProps extends cdk.StackProps {
   ...
   * 1대 이상(4xlarge 이상) 있어야 설치되므로 기본 1. 이 그룹은 MuJoCo CPU 학습(모듈 8)에도 쓰며, 모듈 8 이 scale-cluster.sh 로 2대로 올린다.
   */
...
/**
 * HyperPodEks-<ACCOUNT_ID>: EKS 오케스트레이션 HyperPod 스택 (RL 트랙 모듈 7–10).
 *
