...
export class NetworkingConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: NetworkingProps) {
    ...
    new ec2.CfnVPCEndpoint(this, 'SageMakerApiEndpoint', {
      ...
      tags: [{ key: 'Name', value: `${p}-SageMakerApi-Endpoint` }],
    });
    ...
    for (const svc of ['ssm', 'ssmmessages', 'ec2messages']) {
      const ep = new ec2.CfnVPCEndpoint(this, `${svc}Endpoint`, {
        ...
        securityGroupIds: [endpointSG.ref],
        privateDnsEnabled: true,
        tags: [{ key: 'Name', value: `${p}-${svc}-Endpoint` }],
      });
    ...
    // VPC Flow Log
    const logGroup = new logs.CfnLogGroup(this, 'FlowLogGroup', { retentionInDays: 7, tags: [{ key: 'Name', value: `${p}-FlowLog-Group` }] });
