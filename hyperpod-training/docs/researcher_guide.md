...
```bash
bash /fsx/scratch/aws-physical-ai-recipes/hyperpod-training/scripts/setup_environment.sh
```
...
```bash
REPO_DIR="/fsx/scratch/aws-physical-ai-recipes/hyperpod-training"
...
```bash
python /fsx/scratch/aws-physical-ai-recipes/hyperpod-training/examples/vla/download_dataset.py
```
...
```bash
sbatch /fsx/scratch/aws-physical-ai-recipes/hyperpod-training/slurm-templates/vla/finetune_groot.sbatch
```
...
# 없으면 다시 빌드
bash /fsx/scratch/aws-physical-ai-recipes/hyperpod-training/container/build_and_push_ecr.sh
bash /fsx/scratch/aws-physical-ai-recipes/hyperpod-training/container/import_container.sh
```
