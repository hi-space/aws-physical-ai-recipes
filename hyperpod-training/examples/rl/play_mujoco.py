...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", required=True, help="model_best.zip / model_final.zip / model_<steps>.zip")
    parser.add_argument("--episodes", type=int, default=5)
    parser.add_argument("--video_dir", default="", help="default: <checkpoint dir>/videos")
    ...
    if not args.no_video:
        ...
        mp4 = video_dir / f"{ckpt.stem}.mp4"
        gif = video_dir / f"{ckpt.stem}.gif"
