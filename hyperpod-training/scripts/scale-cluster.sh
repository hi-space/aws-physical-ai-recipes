...
#   ./scale-cluster.sh cpu-c5-4x 2 --wait --cluster hyperpod-eks-<ACCOUNT_ID>   # EKS: 시스템 그룹에 학습용 CPU 노드 추가 (모듈 9)
#   ./scale-cluster.sh gpu-g5-8x 1 --wait --cluster hyperpod-eks-<ACCOUNT_ID>   # EKS: GPU 노드 (모듈 9 §9.7)
#
