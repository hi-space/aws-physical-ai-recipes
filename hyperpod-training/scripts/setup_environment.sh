...
echo "     python ${REPO_DIR}/hyperpod-training/examples/vla/download_dataset.py"
echo "  2. Submit training:"
echo "     sbatch ${REPO_DIR}/hyperpod-training/slurm-templates/vla/finetune_groot.sbatch"
