...
export default memo(function DdpTopologyView({ workers, experiments }: { workers: Worker[]; experiments: Experiment[] }) {
    ...
    <div className="bg-white rounded-lg shadow-sm p-5">
      ...
      <div className="flex gap-8 flex-wrap">
        {activeExperiments.length === 0 && (
          <p className="text-sm text-gray-400 py-4">No active DDP topology to display</p>
        )}
