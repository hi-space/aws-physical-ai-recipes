"""SO-100 single-arm robot modality configuration for GR00T fine-tuning.

SO-100 is a 6-DOF single arm with a wrist camera and a fixed front camera.
"""
...
MODALITY_CONFIG = {
    "video": ModalityConfig(
        delta_indices=[0],
        modality_keys=["front_camera", "wrist_camera"],
    ),
