...
export const resources = defineMessages({
  en: {
    ...
    userPool: 'Cognito user pool', table: 'DynamoDB table', costExplorer: 'Cost Explorer', priceList: 'Price List API',
  },
  ko: {
    ...
    userPool: 'Cognito 사용자 풀', table: 'DynamoDB 테이블', costExplorer: 'Cost Explorer', priceList: 'Price List API',
  },
});
