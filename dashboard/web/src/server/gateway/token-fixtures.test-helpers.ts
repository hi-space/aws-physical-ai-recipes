...
export async function tokenFixture() {
  ...
  const session: GatewaySession = { id: 'derived', kind: 'port-forward', namespace: project.namespace, projectId: project.id, ownerSubject: browser.subject, owner: browser.user,
