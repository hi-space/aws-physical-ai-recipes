...
- [x] `train_rl --task Workshop-SO101-Reach-v0 --headless --num_envs 16 --max_iterations 3` — completes, creates checkpoints
- [x] `train_rl --task Workshop-SO101-Lift-v0 --headless --num_envs 16 --max_iterations 3` — completes, creates checkpoints
- [x] `play_rl --task Workshop-SO101-Reach-Play-v0 --headless` — runs with latest checkpoint (after fix)
- [x] `convert --input_dir ... --output_dir ...` — produces valid LeRobot v2.1 dataset
