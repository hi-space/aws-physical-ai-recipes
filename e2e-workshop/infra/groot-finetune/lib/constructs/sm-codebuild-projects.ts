...
/**
 * SageMaker 학습/추론 이미지 빌드용 공용 CodeBuild 프로젝트 2개 (shared 스택).
...
export class SmContainerBuildProjects extends Construct {
  ...
  constructor(scope: Construct, id: string, props: SmContainerBuildProjectsProps) {
    ...
    this.inferenceProject = new codebuild.Project(this, 'InferenceBuild', {
      projectName: props.inferenceProjectName,
      ...
      logging: {
        cloudWatch: {
          ...
          logGroup: new logs.LogGroup(this, 'InferenceLogGroup', {
            logGroupName: `/aws/codebuild/${props.inferenceProjectName}`,
            retention: logs.RetentionDays.ONE_MONTH,
            removalPolicy: cdk.RemovalPolicy.DESTROY,
          }),
        },
