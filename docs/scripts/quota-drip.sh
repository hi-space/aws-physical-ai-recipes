...
QUEUE=(
  ...
  "us-east-1|sagemaker|L-49E4D2AB|12|ml.g6.xlarge processing (SmokeEval, GPU 필수)"
  "us-west-2|sagemaker|L-49E4D2AB|12|ml.g6.xlarge processing (SmokeEval, GPU 필수)"
  "us-east-1|sagemaker|L-F70A2467|12|ml.g6e.12xlarge training"
  "us-west-2|sagemaker|L-F70A2467|12|ml.g6e.12xlarge training"
  "us-east-1|sagemaker|L-945D83D8|10|ml.g6e.4xlarge training"
  "us-west-2|sagemaker|L-945D83D8|10|ml.g6e.4xlarge training"
  "us-east-1|sagemaker|L-1D84B9D2|12|ml.m5.2xlarge processing"
  "us-west-2|sagemaker|L-1D84B9D2|12|ml.m5.2xlarge processing"
  "us-east-1|sagemaker|L-A15DF696|10|ml.g6e.12xlarge cluster"
  "us-east-1|sagemaker|L-50B5B169|12|ml.g6.12xlarge training (폴백)"
  "us-west-2|sagemaker|L-50B5B169|12|ml.g6.12xlarge training (폴백)"
  "us-east-1|sagemaker|L-C6383286|12|ml.g5.12xlarge training (폴백)"
  "us-west-2|sagemaker|L-C6383286|12|ml.g5.12xlarge training (폴백)"
  ...
  "us-east-1|sagemaker|L-9C8CF3DC|10|ml.g6e.4xlarge cluster"
  "us-east-1|sagemaker|L-24E5A1B2|10|ml.g5.12xlarge cluster (폴백)"
)
